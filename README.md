...
## 게임 규칙
- 적: 상단에서 무작위로 생성되어 내려오며 주기적으로 탄막을 쏩니다. 보스가 살아 있을 때 격추해도 점수가 오르지 않습니다.
- 보스: 점수가 100점 단위에 도달할 때마다 상단 중앙에 등장합니다. 살아 있는 동안 적 처치 점수를 동결시키고, 현재 점수 100점당 탄막 개수가 1개씩 늘어납니다. 보스를 격파하면 추가 점수를 획득합니다.
